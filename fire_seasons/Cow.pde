   ...
   ///////////////////////////////////////////////////////////////
    ...
    {        
        ...
        */
        ...
        if ( abs(scape.getDEM().get((int)loc.x, (int)loc.y) - scape.getDEM().get((int)dest.x, (int)dest.y)) > 50 ){ status = 'R'; println( "NO GO");}
        if ( scape.getTree()[xScape][yScape] > 100 ){ status = 'R'; println( "NO GO");}
        //
